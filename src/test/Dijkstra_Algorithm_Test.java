...
import algorithm.Dijkstra_AdjacencyList_Algorithm;
import algorithm.Dijkstra_OneDimArray_Algorithm;
import algorithm.Dijkstra_TwoDimArray_Algorithm;
...
public class Dijkstra_Algorithm_Test {
	...
	public void TwoDimArray_Complete() {
		...
		Dijkstra_TwoDimArray_Algorithm algorithm = new Dijkstra_TwoDimArray_Algorithm();
	...
	public void AdjacencyList_Complete() throws Exception {
		...
		Dijkstra_AdjacencyList_Algorithm algorithm = new Dijkstra_AdjacencyList_Algorithm();
	...
	public void OneDim_Complete() throws Exception {
		...
		Dijkstra_OneDimArray_Algorithm algorithm = new Dijkstra_OneDimArray_Algorithm();
